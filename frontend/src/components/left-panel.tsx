        ...
        <div className="text-slate-700 mt-2">
          <div
            className={`bg-purple-50 text-purple-600 ${
              !thinkingOpen ? "rounded-md" : "rounded-t-md rounded-b-none"
            } px-2 py-1 text-xs whitespace-no-wrap break-all border border-purple-200 flex justify-between items-center w-full cursor-pointer`}
          ...
          >
            ...
            {thinkingOpen ? <IconCaretDown /> : <IconCaretLeft />}
          </div>
          {thinkingOpen && (
            <div className="w-full bg-purple-25 rounded-b-md px-2 py-2 text-xs whitespace-pre-wrap break-all border-x border-b border-purple-200 scrollbar-thin max-h-[200px] overflow-y-auto text-purple-800">
              {message.thinking}
            </div>
          )}
        </div>
